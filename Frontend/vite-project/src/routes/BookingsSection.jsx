      ...
      <div>
            ...
            >
              <div className="flex flex-col rounded-lg bg-white shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] dark:bg-neutral-700 md:w-full md:flex-row p-8">
                <img
                  ...
                  src={`http://localhost:5000/${booking.house.pictures[0]}`}
                  alt=""
                />
        ...
        {pastBookings.length > 0 ? (
          pastBookings.map((booking) => (
            <div
              key={booking._id}
              className="w-500  bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700"
            >
              <div className="flex flex-col rounded-lg bg-white shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] dark:bg-neutral-700 md:w-full md:flex-row p-8">
                <img
                  className="h-96 w-full rounded-t-lg object-cover md:h-auto md:w-48 md:rounded-none md:rounded-l-lg"
                ...
                <div className="flex flex-col justify-start p-6">
                 ...
                 {reviews.filter((review) => review.booking === booking._id).length === 0 && <Button className="mt-4" onClick={() => {setOpenModal(true); setCurrentId(booking._id);}}>
                    Review your stay
                  </Button>
                  }
