  ...
  return (
    <div>
      ...
      >
        {images[0] && (
          <img
            src={`https://backtea.onrender.com/${images[0]}`}
            alt="image 1"
        ...
        {images[1] && (
          <img
            src={`https://backtea.onrender.com/${images[1]}`}
            alt="image 2"
            className="h-full w-full object-cover "
          />
        )}
        {images[2] && (
          <img
            src={`https://backtea.onrender.com/${images[2]}`}
            alt="image 3"
            className="h-full w-full object-cover "
          />
        )}
            ...
            {images.map((imageLink, index) => (
              <div key={index}>
                <img
                  ...
                  src={`https://backtea.onrender.com/${imageLink}`}
                  alt="gallery-photo"
                />
              </div>
            ))}
