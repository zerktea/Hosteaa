...
export default function CheckoutForm(props) {
  ...
  const handlePay = () => {
      dispatch(createBookingAsync(bookingForm))
      handlePayment()
      toast.success('Payment Successful')
  }
  return (
    <Card className="w-full w-[25rem]">
        <Toaster/>
      <CardHeader
        color="gray"
        floated={false}
      ...
      <CardBody className="!w-full ">
        <Tabs value={type} className="overflow-visible">
          <TabsHeader className="relative z-0 w-[20rem]">
          ...
          >
            <TabPanel value="card" className="p-0 w-full">
              <form className="mt-12 flex flex-col gap-4 w-full">
                <div>
                  <Typography
                    variant="small"
                    color="blue-gray"
            ...
            <TabPanel value="paypal" className="p-0">
              <form className="mt-12 flex flex-col gap-4 w-full w-[20rem]">
                <div>
                  <Typography
                    variant="paragraph"
                    color="blue-gray"
                ...
                <Button size="lg" onClick={handlePay}>pay with paypal</Button>
                <Toaster />
                <Typography
                  variant="small"
                  color="gray"
