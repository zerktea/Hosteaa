...
export default function Header({ onLogout, setSearchTerm, setNumberofGuests }) {
  ...
  const handleChange = (e) => {
    ...
    console.log("Number of guests changed:", e.target.value);
  };
      ...
      {location.pathname === "/#" ||
        (location.pathname === "/" && (
          <div className="flex items-center justify-center lg:self-auto">
            ...
            />
            <div className="relative flex items-center max-w-[11rem] mx-4">
              <button
                type="button"
                id="decrement-button"
                onClick={() => {
                  if (formData.guests > 1) {
                    ...
                    setNumberofGuests(formData.guests - 1);
                  }
                }}
